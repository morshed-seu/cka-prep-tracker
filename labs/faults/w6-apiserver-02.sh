#!/usr/bin/env bash
# CKA fault drill w6-apiserver-02 (lesson 6.6) — plants ONE fault in the
# kube-apiserver static-pod manifest of the LAB cluster.
# Run on the control-plane VM:  sudo bash w6-apiserver-02.sh
...
echo "============================================================"
echo " CKA fault drill w6-apiserver-02"
...
# ---- plant ----
sed -i 's|--etcd-servers=https://127.0.0.1:2379|--etcd-servers=https://127.0.0.1:23790|' "$MANIFEST"

echo
echo "Fault planted."
echo
echo "YOUR MISSION"
echo "  1. Give it a minute; kubectl will start failing."
