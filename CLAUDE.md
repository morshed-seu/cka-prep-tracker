...
| **Intermediate** — composing that machinery into containers, runtimes, images, CNI | `intermediate.html` | `materials/i0…i13.html` | [`docs/INTERMEDIATE-TRACK.md`](docs/INTERMEDIATE-TRACK.md) | 🚧 I-S1…I-S9 done; **tracker complete — all 195 cp tickable (I0–I13, 78 h)**, `PUBLISHED=[0,1,2,3,4]` (`materials/i0.html`…`i4.html` shipped; I-S10 writes `materials/i5.html`) |
...
| I-S10 … I-S18 | `materials/i5.html` … `materials/i13.html`, one module per session | |
