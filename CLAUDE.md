...
| **Intermediate** — composing that machinery into containers, runtimes, images, CNI | `intermediate.html` | `materials/i0…i13.html` | [`docs/INTERMEDIATE-TRACK.md`](docs/INTERMEDIATE-TRACK.md) | 🚧 I-S1…I-S7 done; **tracker complete — all 195 cp tickable (I0–I13, 78 h)**, `PUBLISHED=[0,1,2]` (`materials/i0.html`, `i1.html` + `i2.html` shipped; I-S8 writes `materials/i3.html`) |
...
| I-S8 … I-S18 | `materials/i3.html` … `materials/i13.html`, one module per session | |
