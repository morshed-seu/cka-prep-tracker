...
| **Intermediate** — composing that machinery into containers, runtimes, images, CNI | `intermediate.html` | `materials/i0…i13.html` | [`docs/INTERMEDIATE-TRACK.md`](docs/INTERMEDIATE-TRACK.md) | 🚧 I-S1…I-S5 done; **tracker complete — all 195 cp tickable (I0–I13, 78 h)**, `PUBLISHED=[0]` (`materials/i0.html` shipped; I-S6 writes `materials/i1.html`) |
