...
| **Intermediate** — composing that machinery into containers, runtimes, images, CNI | `intermediate.html` | `materials/i0…i13.html` | [`docs/INTERMEDIATE-TRACK.md`](docs/INTERMEDIATE-TRACK.md) | 🚧 I-S1…I-S8 done; **tracker complete — all 195 cp tickable (I0–I13, 78 h)**, `PUBLISHED=[0,1,2,3]` (`materials/i0.html`, `i1.html`, `i2.html` + `i3.html` shipped; I-S9 writes `materials/i4.html`) |
