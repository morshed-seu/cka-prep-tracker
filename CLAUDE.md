...
| P2 | materials/w2.html (kubeadm/PKI/lifecycle) + cheatsheets/etcd-card.html | ⬜ next |
| P3 | materials/w3.html (workloads/scheduling/Helm/Kustomize) | ⬜ |
| P4 | materials/w4.html (networking; heaviest diagrams) | ⬜ |
